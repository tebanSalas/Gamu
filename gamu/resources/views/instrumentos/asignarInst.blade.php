    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-info">
                <div class="panel-heading">Seleccione el estudiante, seguidamente el instrumento que le asiganará al mismo</div>
              ...
              <!-- Modal content-->
                          <div class="modal-content">
                            <div class="modal-header">
                              ...
                              <h4 class="modal-title">Ingrese el nombre del estudiante que desea buscar:</h4>
                            </div>
...
<!-- Beca -->
                    <div class="form-group">
                      ...
                      <div class="col-md-2" >
                        <button type="button" class="btn btn-warning col-md-10" data-toggle="modal" data-target="#inst">Buscar</button>
                      </div>
                        <!-- Modal -->
                        <div id="inst" class="modal fade" role="dialog">
                          <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            <div class="modal-header">
                              <button type="button" class="close" data-dismiss="modal">&times;</button>
                              <h4 class="modal-title">Ingrese el nombre del instrumento que desea buscar:</h4>
                            </div>
                            <div class="modal-body">
                              <input type="text" class="form-control" name="busqueda" id="busqueda" placeholder="Ingrese el nombre">
                            </div>

...
PMA_messages['strHoverDbFastFilter'] = "Para filtrar todas las bases de datos en servidor, presione Enter después de un término de búsqueda";
PMA_messages['strHoverFastFilter'] = "Para filtrar los %s en base de datos, presione Enter después de un término de búsqueda";
PMA_messages['strTables'] = "mesas";
PMA_messages['strViews'] = "Vistas";
PMA_messages['strProcedures'] = "procedimientos";
PMA_messages['strEvents'] = "eventos";
PMA_messages['strFunctions'] = "Funciones";
...
PMA_messages['strNoLocalStorage'] = "Tu navegador web no soporta el almacenamiento de preferencias a nivel local, o el límite de almacenamiento ha sido alcanzado, algunas características podrían no funcionar correctamente. En Safari, ésto puede deberse al \"Modo de Navegación Privada\".";
